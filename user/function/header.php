...
<body>
    <header class="header">
        <a href="../page/tentang.php" class="logo">
            <img src="../../img/Logo.png" alt="Buya_Galung">
        </a>

        <nav class="navbar">
            <a href="../page/home.php" <?php if ($currentPage == 'home.php') echo 'class="active"'; ?>>Beranda</a>
            <a href="../page/menu.php" <?php if ($currentPage == 'menu.php' || $currentPage == 'detail_menu.php') echo 'class="active"'; ?>>Menu</a>
            <a href="../page/ulasan.php" <?php if ($currentPage == 'ulasan.php' || $currentPage == 'beri_ulasan.php') echo 'class="active"'; ?>>Ulasan</a>
            <a href="../page/tentang.php" <?php if ($currentPage == 'tentang.php') echo 'class="active"'; ?>>Tentang</a>
        </nav>

        <nav class="fitur">
            <a href="../fitur/account.php" class="logo-account <?php if ($currentPage == 'account.php') echo 'active'; ?>"><i class='bx bxs-user-circle' ></i></a>
            <a href="../fitur/keranjang.php" class="logo-keranjang <?php if ($currentPage == 'keranjang.php' || $currentPage == 'checkout.php' || $currentPage == 'bayar.php') echo 'active'; ?>"><i class='bx bxs-cart' ></i></a>
        </nav>
