                ...
                <div class="menu-item">
                    ...
                    <div class="menu-details">
                        ...
                        <div class="button-container">
                            <?php
                            if (isset($_SESSION["login_user"])) {
                                echo "<button type='button' onclick='location.href=\"../fitur/beri_ulasan.php?id_menu={$row['id_menu']}&kategori={$kategori_terpilih}\"' class='btn btn-ulas'>Beri Ulasan</button>";
                            }
                            ?>
                        </div>
                    </div>
